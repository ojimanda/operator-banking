...
public class AuthConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.authorizeHttpRequests().requestMatchers("/admin").hasAnyAuthority("admin")
				...
				.requestMatchers("/admin/paketdata").hasAnyAuthority("admin")
				.requestMatchers("/admin/paketdata/delete").hasAnyAuthority("admin")
				.requestMatchers("/admin/tiket/delete").hasAnyAuthority("admin")
